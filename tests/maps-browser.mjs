...
try{
 ...
 await fixture(mini);await mini.goto('http://127.0.0.1:10086');await mini.locator('input').first().fill(mapUsername);await mini.locator('input').nth(1).fill(mapPassword);await mini.getByText('登录',{exact:true}).click();
