...
export APP_MODE=business WECHAT_PAY_ENABLED=false WECHAT_TRANSFER_ENABLED=false WECHAT_PROFITSHARING_ENABLED=false
...
bash scripts/pnpm.sh exec tsx --test tests/wechat-auth.test.ts